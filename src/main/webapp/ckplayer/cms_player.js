...
function ckstyle(){//定义总的风格
	var ck = new Object();
    ck.cpath = 'ckplayer/sina/'; //风格总路径
	ck.mylogo = 'mylogo.png';//开始加载的logo,如果为空就不加载
	//ck.logo = 'logo.swf,2,320,8';//logo图片，对齐方式，0左上1左下2右上3右下，x偏移量，y偏移量
	ck.logo = '';
	...
	//ck.control_rel='related.swf,related.xml?id=[$pat],0';//视频播放结束后分享和推荐视频
	control_rel='';
    //右侧调整按钮的文件，坐标
    ...
    ck.pm_ctbar = '1,2,0,-26,0,26,0,0,3000';
    ...
    ck.pm_sch = '1,2,127,-26,200,26,0,13,26';
    //进度条的参数，这里分二种情况，前面7个参数对照控制栏的，第8个参数是拖动按钮的宽，第9个参数是拖动按钮的高
    ck.pm_play = '0,2,0,-26';
    //播放和暂停按钮的坐标
    ck.pm_clock = '0,2,42,-22,70';
    //已播放时间的坐标和宽度
    ck.pm_clock2 = '0,2,42,-22,70';
    //总时间的坐标和宽度
    ck.pm_full = '2,2,-100,-26';
    //全屏和取消全屏按钮的坐标
    ck.pm_vol = '2,2,-155,-26,50,26,13,26';
    //音量调节框的坐标，宽度，高度，拖动按钮的宽度,高度
    ck.pm_sound = '2,2,-190,-26';
    //静音和取消静音的坐标
    ck.pm_fastf = '2,2,-15,-185';
    //快进按钮的坐标
    ck.pm_fastr = '0,2,0,-185';
    //快退按钮的坐标
    ck.pm_fasttime = '10';
    //快进和快退的秒数
    ck.pm_video_bottom = '26,26';
    ...
    ck.pm_advstatus = '1,3,190,28';
    //前置广告是否显示静音按钮(0/1),位置(0/1/2/3),x,y
    ck.pm_advjp = '1,0,3,98,28';
    //前置广告是否显示跳过广告按钮,跳过按钮触发对象(值0/1,0是直接跳转,1是触发js:function ckadjump(){}),对齐方式,x,y
    ck.pm_advtime = '100,1,15,26';
    //前置广告倒计时文本宽,对齐方式,x,y
    ck.pm_advmarquee = '1,1,2,5,-46,20,20,0,0,15,3000,1,20,0x000000';
    ...
    ck.pm_buffer = '25,20,0,8,{font color="#fdfdfd" face="arial"}[$buffer]%{/font}';
    ...
    ck.pr_clock2 = '{font color="#666666" size="12" face="arial"}[$Time] ~ [$TimeAll]{/font}';
    //同pr_clock,这二个是相等的，主要是为了方便在不同的地方调用已播放时间和总时间
    ck.pr_adv = '{font color="#ffffff" size="12" face="arial"}广告还剩：{font color="#dee309"}{b}[$Second]{/b}{/font} 秒{/font}';
