        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>【高一】过六成大学生后悔选错专业，您的文理选对了吗？,短信</caption>
                ...
                <table class="score-table">
                    <caption>【高一】过六成大学生后悔选错专业，您的文理选对了吗？,消息</caption>
        		...
        		<table class="score-table">
                    <caption>【高二】高考知识点学习结束，成绩不稳怎么办？,短信</caption>
                ...
                <table class="score-table">
                    <caption>【高二】高考知识点学习结束，成绩不稳怎么办？,消息</caption>
