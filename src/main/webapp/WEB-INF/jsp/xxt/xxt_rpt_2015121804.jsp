        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>【校讯通】文理分科之2015高考大数据</caption>
        		...
        		<table class="score-table">
                    <caption>【校园+】文理分科之2015高考大数据</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【高二】期末备考之盘点阻碍成绩提高的错误学习方法</caption>
                ...
                <table class="score-table">
                    <caption>【校园+】【高二】期末备考之盘点阻碍成绩提高的错误学习方法</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【高三】期末备考之盘点阻碍成绩提高的错误学习方法</caption>
                ...
                <table class="score-table">
                    <caption>【校园+】【高三】期末备考之盘点阻碍成绩提高的错误学习方法</caption>
