        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班校讯通家长用户<br>带孩子，不只是母亲的事儿！</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、二年级<br>小学阶段，补课不如补习惯 ！</caption>
                ...
                <table class="score-table">
                    <caption>小学三、四年级<br>小学阶段，补课不如补习惯 ！</caption>
                ...
                <table class="score-table">
                    <caption>小学五年级<br>小学阶段，补课不如补习惯 ！</caption>
                ...
                <table class="score-table">
                    <caption>小学六年级<br>升学必知：六年级下学期需做好哪些事情？</caption>
                ...
                <table class="score-table">
                    <caption>初一<br>与青春期孩子相处的十大学问！</caption>
                ...
                <table class="score-table">
                    <caption>初二<br>与青春期孩子相处的十大学问！</caption>
                ...
                <table class="score-table">
                    <caption>初三<br>2015陕西中考数学考试解读与题型预测</caption>
                ...
                <table class="score-table">
                    <caption>高一家长用户<br>优秀学生和一般学生的差别不足一小时！</caption>
                ...
                <table class="score-table">
                    <caption>高二家长用户<br>优秀学生和一般学生的差别不足一小时！</caption>
                ...
                <table class="score-table">
                    <caption>高三家长用户<br>今年陕西高校专业重大调整，你知道了吗？ </caption>
