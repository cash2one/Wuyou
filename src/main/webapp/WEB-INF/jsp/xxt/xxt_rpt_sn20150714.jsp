        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班<br>入学前如何培养孩子记作业写作业的习惯？</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、二年级<br>说说孩子“不经意之间”的进步</caption>
                ...
                <table class="score-table">
                    <caption>小学三、四年级<br>孩子犯错，不要着急批评，问这8句话即可</caption>
                ...
                <table class="score-table">
                    <caption>小学五、六年级<br>我是怎么控制孩子看电视的</caption>
                ...
                <table class="score-table">
                    <caption>初一、初二<br>爸妈，拜托以后别再这么说我了</caption>
                ...
                <table class="score-table">
                    <caption>初三<br>从孩子的角度建议家长如何安排孩子的暑假</caption>
                ...
                <table class="score-table">
                    <caption>高一<br>高一就要结束了，高一学生该学会的几点。</caption>
                ...
                <table class="score-table">
                    <caption>高二<br>教孩子这样做！高效复习，迎战高三复习季！</caption>
