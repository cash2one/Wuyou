        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班校讯通家长用户<br>玩积木也能学数学，快来学学吧！</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、二年级<br>让孩子像爱看动画片一样爱学习！</caption>
                ...
                <table class="score-table">
                    <caption>小学三、四年级<br>孩子计算题老出错？问题就在这！</caption>
                ...
                <table class="score-table">
                    <caption>小学五年级<br>五年级语文要提高？看这里就对了</caption>
                ...
                <table class="score-table">
                    <caption>小学六年级<br>上初中！一定带着七个好习惯！</caption>
                ...
                <table class="score-table">
                    <caption>初一<br>赶快收藏！初一下学期最关键的五个好习惯！</caption>
                ...
                <table class="score-table">
                    <caption>初二<br>“学渣”“逆袭”，可以这样打草稿</caption>
                ...
                <table class="score-table">
                    <caption>初三家长用户<br>中考前两个月，必做好三件事！</caption>
                ...
                <table class="score-table">
                    <caption>高一家长用户<br>“我也是醉了”--孩子成绩竟是这么跌下去的！ </caption>
                ...
                <table class="score-table">
                    <caption>高二家长用户<br>高二！拿“神马”有效地执行你的学习计划？</caption>
                ...
                <table class="score-table">
                    <caption>高三家长用户<br>猛戳吧！最后两个月，如何做状元家长！ </caption>
