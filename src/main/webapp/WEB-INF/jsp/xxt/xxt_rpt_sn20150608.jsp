        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班、小学一、二年级校讯通家长用户<br>亲子重要还是夫妻重要？</caption>
        		...
        		<table class="score-table">
                    <caption>小学三、四年级<br>80后辣妈写给孩子的道歉信</caption>
                ...
                <table class="score-table">
                    <caption>小学五、六年级<br>如何让孩子对学习上瘾？</caption>
                ...
                <table class="score-table">
                    <caption>初一<br>督促孩子自主学习，家长们的妙招！</caption>
                ...
                <table class="score-table">
                    <caption>初二<br>你能清楚地说出孩子的优缺点吗</caption>
                ...
                <table class="score-table">
                    <caption>初三<br>如何让孩子对学习上瘾？</caption>
                ...
                <table class="score-table">
                    <caption>高一<br>缺失的父亲+焦虑的母亲+失控的孩子</caption>
                ...
                <table class="score-table">
                    <caption>高二<br>高考各科状元学习方法分享</caption>
                ...
                <table class="score-table">
                    <caption>高三<br>高考志愿技巧之如何选择好专业？</caption>
