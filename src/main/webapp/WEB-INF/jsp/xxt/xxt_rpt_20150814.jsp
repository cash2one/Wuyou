        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>全国卷对新高二生分科学习的影响,短信</caption>
                ...
                <table class="score-table">
                    <caption>全国卷对新高二生分科学习的影响,消息</caption>
        		...
        		<table class="score-table">
                    <caption>新高三党必看！2016年高考全年大事记,短信</caption>
                ...
                <table class="score-table">
                    <caption>新高三党必看！2016年高考全年大事记,消息</caption>
        		...
        		<table class="score-table">
                    <caption>暑假孩子“不听话”，怎么办？,短信</caption>
                ...
                <table class="score-table">
                    <caption>暑假孩子“不听话”，怎么办？,消息</caption>
                ...
                <table class="score-table">
                 ...
                 <table class="score-table">
                    <caption>初三所学占中考过半，如何准备？,短信</caption>
                ...
                <table class="score-table">
                    <caption>初三所学占中考过半，如何准备？,消息</caption>
