    ...
    <div class="page-main">
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<caption>2014年6月20日</caption>
                    <caption>立足城市选大学</caption>
                ...
                <table class="score-table">
                    ...
                    <c:forEach var="item" items="${rpt }" begin="13" end="22">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
                <caption>2014年6月22日</caption>
                    <caption>掌握填报技巧，提高志愿“命中率”</caption>
                    <c:forEach var="item" items="${rpt }" begin="23" end="34">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
                    <caption>校讯通公共账号点击情况</caption>
                    <c:forEach var="item" items="${rpt }" begin="35" end="44">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
               		<caption>2014年6月24日</caption>
                    <caption>高考志愿填报写给家长们的话——青春的一场相遇</caption>
                    <c:forEach var="item" items="${rpt }" begin="45" end="56">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
                    <caption>校讯通公共账号点击情况</caption>
                    <c:forEach var="item" items="${rpt }" begin="57" end="66">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
