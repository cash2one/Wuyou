        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>【校讯通】期中考前后，家长应这样跟初二生谈学习</caption>
        		...
        		<%-- <table class="score-table">
                    <caption>【校园+】期中考前后，家长应这样跟初二生谈学习</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】名师支招：期中考高分法宝</caption>
                    <c:forEach var="item" items="${rpt }" begin="3" end="4">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
               ...
               <%--  <table class="score-table">
                    <caption>【校园+】名师支招：期中考高分法宝</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】名师点拨：新高一生备战期中考高效秘籍</caption>
                ...
                <%-- <table class="score-table">
                    <caption>【校园+】名师点拨：新高一生备战期中考高效秘籍</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【高二】期中考临近，这样做短时间内可多抢30分！</caption>
                    <c:forEach var="item" items="${rpt }" begin="7" end="8">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
               ...
               <%--  <table class="score-table">
                    <caption>【校园+】【高二】期中考临近，这样做短时间内可多抢30分！</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【高三】期中考临近，这样做短时间内可多抢30分！</caption>
               ...
               <%--  <table class="score-table">
                    <caption>【校园+】【高三】期中考临近，这样做短时间内可多抢30分！</caption>
