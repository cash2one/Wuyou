        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班校讯通家长用户<br>玩出新花样，宝宝的创造力总是出乎意料</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、二年级<br>学习是件综合的事</caption>
                ...
                <table class="score-table">
                    <caption>小学三、四年级<br>为孩子鼓掌，孩子会还你惊喜</caption>
                ...
                <table class="score-table">
                    <caption>小学五年级<br>一个清华学霸给小学阶段的12条忠告！</caption>
                ...
                <table class="score-table">
                    <caption>小学六年级<br>小升初衔接期亲子关系巧应对</caption>
                ...
                <table class="score-table">
                    <caption>初一<br>努力成为好家长的我们，到底做错了什么？</caption>
                ...
                <table class="score-table">
                    <caption>初二<br>“非诚勿扰”嘉宾主持黄菡老师的教育心得</caption>
                ...
                <table class="score-table">
                    <caption>初三<br>一分钟定分数！揭秘中考语文作文阅卷过程</caption>
                ...
                <table class="score-table">
                    <caption>高一家长用户<br>高一数学要提分，先回头衔接好初升高</caption>
                ...
                <table class="score-table">
                    <caption>高二家长用户<br>高二生应该这样学习英语！</caption>
                ...
                <table class="score-table">
                    <caption>高三家长用户<br>高考临近，高三家长该做与不该做的事情！ </caption>
