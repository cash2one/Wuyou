        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班校讯通家长用户<br>注意啦！宝宝再爱看电视，也要注意这些细节！</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、二年级<br>小学的重点不在成绩，在于阅读！</caption>
                ...
                <table class="score-table">
                    <caption>小学三、四年级<br>不良习惯早预防，小学里要养成的7大习惯</caption>
                ...
                <table class="score-table">
                    <caption>小学五年级<br>不良习惯早预防，小学里要养成的7大习惯</caption>
                ...
                <table class="score-table">
                    <caption>西安小六<br>西安小升初严禁考奥数</caption>
                ...
                <table class="score-table">
                    <caption>其他地市小六<br>小升初孩子的心理变化</caption>
                ...
                <table class="score-table">
                    <caption>初一<br>清华北大不是梦，从初一开始吧</caption>
                ...
                <table class="score-table">
                    <caption>初二<br>我们该怎么关注初二的学生们</caption>
                ...
                <table class="score-table">
                    <caption>初三<br>西安市五大知名中学和它们分校的故事</caption>
                ...
                <table class="score-table">
                    <caption>高一<br>天天补课，俞敏洪的四门珍藏课，你补了吗</caption>
                ...
                <table class="score-table">
                    <caption>高二<br>高二学生如何修炼作文迎战高考 </caption>
                ...
                <table class="score-table">
                    <caption>高三<br>作业，考试，高三生该如何应对自如？</caption>
                    <c:forEach var="item" items="${rpt }" begin="21" end="22">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
