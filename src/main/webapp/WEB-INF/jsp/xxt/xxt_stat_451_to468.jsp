        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>【小四】推荐生取消，尖子生何去何从</caption>
               ...
               <table class="score-table">
                    <caption>【小五】推荐生取消，尖子生何去何从</caption>
                ...
                <table class="score-table">
                    <caption>【小六】推荐生取消，尖子生何去何从</caption>
                ...
                <table class="score-table">
                    <caption>【初一】一上初中，为何“牛娃”沦为“普通娃”</caption>
                ...
                <table class="score-table">
                    <caption>【初二】初二生学习的“三大难”与“三大招”</caption>
                ...
                <table class="score-table">
                    <caption>【高一】华附名师：首次期中考决定文理分科</caption>
                ...
                <table class="score-table">
                    <caption>【高二】文理选对了吗？高二期中考可知</caption>
                    <c:forEach var="item" items="${rpt }" begin="59" end="64">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
                    <caption>校讯通公共账号点击情况</caption>
                    <c:forEach var="item" items="${rpt }" begin="65" end="68">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
                    <caption>【高三】独家爆料：节后6场高三“连环考”杀到</caption>
                    <c:forEach var="item" items="${rpt }" begin="69" end="74">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
                    <caption>校讯通公共账号点击情况</caption>
                    <c:forEach var="item" items="${rpt }" begin="75" end="78">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
