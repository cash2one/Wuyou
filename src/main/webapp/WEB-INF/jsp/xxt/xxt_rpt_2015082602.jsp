        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>【校讯通】【小班】【中班】开学第一周，与孩子聊聊这些！</caption>
        		...
        		<%-- <table class="score-table">
                    <caption>【校园+】【小班】【中班】开学第一周，与孩子聊聊这些！</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【大班】小学一年级新生开学必备“利器”</caption>
                    <c:forEach var="item" items="${rpt }" begin="3" end="4">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                ...
                <%-- <table class="score-table">
                    <caption>【校园+】【大班】小学一年级新生开学必备“利器”</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【小一】【小二】教养，从改变说话方式开始</caption>
               ...
               <%--  <table class="score-table">
                    <caption>【校园+】【小一】【小二】教养，从改变说话方式开始</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【小三】【小四】【小五】开学如何不做“低头族”？三个动作就搞定</caption>
                    <c:forEach var="item" items="${rpt }" begin="7" end="8">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                ...
                <%-- <table class="score-table">
                    <caption>【校园+】【小三】【小四】【小五】开学如何不做“低头族”？三个动作就搞定</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【小六】初一新生家长“三大忌”</caption>
               ...
               <%--  <table class="score-table">
                    <caption>【校园+】【小六】初一新生家长“三大忌”</caption>
