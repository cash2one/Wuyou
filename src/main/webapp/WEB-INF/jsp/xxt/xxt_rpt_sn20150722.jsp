        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班、小学一、二年级<br>孩子偷拿家里的钱，怎么办？</caption>
        		...
        		<table class="score-table">
                    <caption>小学三、四年级<br>考试完了娃娃天天守着电脑，如何拆招？</caption>
                ...
                <table class="score-table">
                    <caption>小学五、六年级<br>孩子没礼貌，原因竟然是……</caption>
                ...
                <table class="score-table">
                    <caption>初一、初二<br>你家孩子喜欢关紧自己的房门吗</caption>
                ...
                <table class="score-table">
                    <caption>初三<br>【本周话题】中学生炒股，你怎么看</caption>
                ...
                <table class="score-table">
                    <caption>高一<br>预防孩子网瘾的九大措施</caption>
                ...
                <table class="score-table">
                    <caption>高二<br>过来人说：怎样当好高三家长？</caption>
