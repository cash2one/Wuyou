        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班校讯通家长用户<br>幼升小新政来袭，你想知道的都在这里！</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、二年级<br>小学六年，为什么要狠抓一二年级</caption>
                ...
                <table class="score-table">
                    <caption>小学三、四年级<br>补课不如补习惯!家长认清这点非常重要!</caption>
                ...
                <table class="score-table">
                    <caption>小学五年级<br>五年级，再不开始备战小升初就晚了！</caption>
                ...
                <table class="score-table">
                    <caption>小学六年级<br>杜绝腐败！2015山西小升初在阳光下运行！</caption>
                ...
                <table class="score-table">
                    <caption>初一<br>初一晚上这么学，绝对“逆袭”上清华！</caption>
                ...
                <table class="score-table">
                    <caption>初二<br>早看早受益！备战中考，初二如何早下手？</caption>
                ...
                <table class="score-table">
                    <caption>初三家长用户<br>最新政策解读：为孩子的中考全程护航！</caption>
                ...
                <table class="score-table">
                    <caption>高一家长用户<br>独家推荐！高一数学各种题型解题攻略  </caption>
                ...
                <table class="score-table">
                    <caption>高二家长用户<br>高二孩子的福音！2016年高考更公平了！</caption>
                ...
                <table class="score-table">
                    <caption>高三家长用户<br>名校2015高三模考数学真题解密 </caption>
