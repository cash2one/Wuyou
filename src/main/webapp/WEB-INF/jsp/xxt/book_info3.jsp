...
var idtype = GetQueryString("idtype");

if(idtype == 1205){
	document.getElementsByClassName("th1")[2].innerHTML = "孩子年龄"
}
if(idtype == 1222){
	document.getElementsByClassName("th1")[2].innerHTML = "孩子年级"
}
if(idtype == 1227 ||idtype == 1242){
	document.getElementsByClassName("th1")[2].innerHTML = "年级"
}
if(idtype == 1262){
	document.getElementsByClassName("th1")[2].innerHTML = "路线选择"
}
