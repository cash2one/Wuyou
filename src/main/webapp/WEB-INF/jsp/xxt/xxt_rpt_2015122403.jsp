        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>【校讯通】期末备考宝典之二：收藏！提高成绩的三大诀窍！</caption>
        		...
        		<table class="score-table">
                    <caption>【校园+】期末备考宝典之二：收藏！提高成绩的三大诀窍！</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】班主任总结的历年考试前5名期末复习技巧</caption>
                ...
                <table class="score-table">
                    <caption>【校园+】班主任总结的历年考试前5名期末复习技巧</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】“中考第一仗”之二：为何孩子很努力，但进步不明显</caption>
                ...
                <table class="score-table">
                    <caption>【校园+】“中考第一仗”之二：为何孩子很努力，但进步不明显</caption>
