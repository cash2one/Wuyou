        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>【小三】【小四】小学教材改革，小升初英语巨变咋应对？,短信</caption>
                ...
                <table class="score-table">
                    <caption>【小三】【小四】小学教材改革，小升初英语巨变咋应对？,消息</caption>
        		...
        		<table class="score-table">
                    <caption>【小五】小学教材改革，小升初英语巨变咋应对？,短信</caption>
                ...
                <table class="score-table">
                    <caption>【小五】小学教材改革，小升初英语巨变咋应对？,消息</caption>
        		...
        		<table class="score-table">
                    <caption>【小六】小学教材改革，小升初英语巨变咋应对？,短信</caption>
                ...
                <table class="score-table">
                    <caption>【小六】小学教材改革，小升初英语巨变咋应对？,消息</caption>
                ...
                <table class="score-table">
                    <caption>【高三】孩子全省排几名？“广一模分析报告”话你知！,短信</caption>
                ...
                <table class="score-table">
                    <caption>【高三】孩子全省排几名？“广一模分析报告”话你知！,消息</caption>
                    <c:forEach var="item" items="${rpt }" begin="38" end="42">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
