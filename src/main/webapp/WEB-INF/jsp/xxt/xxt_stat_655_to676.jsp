        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>【广州市】【初三】名师解密区统考</caption>
                ...
                <table class="score-table">
                    <caption>【广州市】【高一】《2014大学生就业蓝皮书》发布</caption>
                ...
                <table class="score-table">
                    <caption>【广州市】【高二】期末不抓紧，高考成绩两极分化！</caption>
                    <c:forEach var="item" items="${rpt }" begin="25" end="32">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
                    <caption>校讯通公共账号点击情况</caption>
                    <c:forEach var="item" items="${rpt }" begin="33" end="36">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
                    <caption>【广州市】【高三】看分测“钱途”：广东名校高薪专业一览</caption>
                    <c:forEach var="item" items="${rpt }" begin="37" end="44">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
                    <caption>校讯通公共账号点击情况</caption>
                    <c:forEach var="item" items="${rpt }" begin="45" end="48">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
                    <caption>【广州市】【小六】“名校行”或成直接报名通道</caption>
                    <c:forEach var="item" items="${rpt }" begin="49" end="56">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
