        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>国际大师权威点拨艺术特长培养,短信</caption>
                ...
                <table class="score-table">
                    <caption>国际大师权威点拨艺术特长培养,消息</caption>
        		...
        		<table class="score-table">
                    <caption>国际艺术大师告诉您，如何零门槛学舞蹈,短信</caption>
                ...
                <table class="score-table">
                    <caption>国际艺术大师告诉您，如何零门槛学舞蹈,消息</caption>
        		...
        		<table class="score-table">
                    <caption>名师点拨：新高一生备战期中考高效秘籍,短信</caption>
                ...
                <table class="score-table">
                    <caption>名师点拨：新高一生备战期中考高效秘籍,消息</caption>
