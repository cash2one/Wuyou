        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班校讯通家长用户<br>零食这样吃才健康！</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、二年级校讯通家长用户<br>孩子们夏天必吃的长高菜</caption>
                ...
                <table class="score-table">
                    <caption>小学三、四年级校讯通家长用户<br>仅需四招，培养孩子的口算能力！</caption>
                ...
                <table class="score-table">
                    <caption>小学五年级校讯通家长用户<br>暑假日记怎么写？干货在这里！</caption>
                ...
                <table class="score-table">
                    <caption>小学六年级校讯通家长用户<br>小升初衔接的重要性和主要误区</caption>
                ...
                <table class="score-table">
                    <caption>初一年级校讯通家长用户<br>入伏在即，防暑食疗妙招免费送</caption>
                ...
                <table class="score-table">
                    <caption>初二年级校讯通家长用户<br>【性格测试】您是哪种动物？超准……</caption>
                ...
                <table class="score-table">
                    <caption>初三年级校讯通家长用户<br>初升高暑期：何处安放孩子的假日时光</caption>
                ...
                <table class="score-table">
                    <caption>高一年级校讯通家长用户<br>最差劲暑假学习方法盘点，您“躺枪”没？</caption>
                ...
                <table class="score-table">
                    <caption>高二年级校讯通家长用户<br>准高三必看，2016年高考全年大事表</caption>
                ...
                <table class="score-table">
                    <caption>高三年级校讯通家长用户<br>【高四党】复读有标准，入读需谨慎！</caption>
                ...
                <table class="score-table">
                    <caption>各年级校讯通教师用户<br>12部关于咱教师的经典电影，暑期一定要看！</caption>
