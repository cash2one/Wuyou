        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>孩子成绩下滑都是“三年级现象”惹的祸</caption>
                ...
                <table class="score-table">
                    <caption>补差的黄金时间：新初三暑期学习攻略</caption>
                ...
                <table class="score-table">
                    <caption>新高一生需知道的广东高考变化</caption>
               ...
               <%--  <table class="score-table">
                ...
                <table class="score-table">
                    <caption>【广州市】新高一生需知道的广东高考变化</caption>
                ...
                <table class="score-table">
                    <caption>【广州市】如何利用高二期末考，为高考初定目标</caption>
                ...
                <table class="score-table">
                    <caption>【广州市】小升初考试改革——“硬成绩+软实力”成名校录取必备条件</caption>
