        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班校讯通家长用户<br>还在跟孩子说不要跟陌生人说话？你错了！</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、二年级校讯通家长用户<br>如何让孩子对学习“上瘾”？不看就晚了！</caption>
                ...
                <table class="score-table">
                    <caption>小学三、四年级校讯通家长用户<br>如何快速提高孩子的学习注意力</caption>
                ...
                <table class="score-table">
                    <caption>小学五年级校讯通家长用户<br>培养孩子心理承受力，是现在社会必须要的！</caption>
                ...
                <table class="score-table">
                    <caption>小学六年级校讯通家长用户<br>备战小升初，“语数外”有“叁”招</caption>
                ...
                <table class="score-table">
                    <caption>初一年级校讯通家长用户<br>孩子最反感的“口头禅”，您“中枪”了吗？</caption>
                ...
                <table class="score-table">
                    <caption>初二年级校讯通家长用户<br>初二学生最喜欢的父母，确定有“您”吗？</caption>
                ...
                <table class="score-table">
                    <caption>初三年级校讯通家长用户<br>中考生备考吃什么可提高学习效率？</caption>
                ...
                <table class="score-table">
                    <caption>高一年级校讯通家长用户<br>请用正确的复习方式！否则成绩必定很惨！</caption>
                ...
                <table class="score-table">
                    <caption>高二年级校讯通家长用户<br>高二期末冲刺，像“学霸”一样去复习！</caption>
                ...
                <table class="score-table">
                    <caption>高三年级校讯通家长用户<br>分数只是入场券，志愿填报才是最终决赛</caption>
