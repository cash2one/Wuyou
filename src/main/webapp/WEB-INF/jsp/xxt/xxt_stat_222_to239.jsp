        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>【中班】最后两周如何让宝宝“收心”</caption>
        		...
        		<table class="score-table">
                    <caption>【小二】判断孩子是否有良好学习习惯的20个标准</caption>
                ...
                <table class="score-table">
                    <caption>【小六】初一新生须知的数学科学习特点</caption>
                ...
                <table class="score-table">
                    <caption>校讯通公共账号点击情况</caption>
                    <c:forEach var="item" items="${rpt }" begin="29" end="32">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
                    <caption>【初一】不做课外题的执信“非典型学霸”</caption>
                ...
                <table class="score-table">
                    <caption>【初三】准备两周，高一数学不“栽跟斗”</caption>
                ...
                <table class="score-table">
                    <caption>【高一】高二上学期数学、英语重难点与易错点</caption>
                ...
                <table class="score-table">
                    <caption>【高二】2014高考，学渣是怎样变学霸的</caption>
