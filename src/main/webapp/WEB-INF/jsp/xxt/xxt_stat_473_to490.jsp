        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>【小班】家长不得不备的“幼儿防走失手册”</caption>
               ...
               <table class="score-table">
                    <caption>【中班】家长不得不备的“幼儿防走失手册”</caption>
                ...
                <table class="score-table">
                    <caption>【大班】家长不得不备的“幼儿防走失手册”</caption>
                ...
                <table class="score-table">
                    <caption>【小一】孩子太顽皮？多动症儿童其实前途无量</caption>
                ...
                <table class="score-table">
                    <caption>【小二】孩子太顽皮？多动症儿童其实前途无量</caption>
                ...
                <table class="score-table">
                    <caption>【小三】孩子太顽皮？多动症儿童其实前途无量</caption>
                ...
                <table class="score-table">
                    <caption>【小四】取消午休费，孩子安全谁来保障</caption>
                ...
                <table class="score-table">
                    <caption>【小五】过八成民校负责人认可的升学新评价</caption>
                    <c:forEach var="item" items="${rpt }" begin="57" end="62">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
                    <caption>校讯通公共账号点击情况</caption>
                    <c:forEach var="item" items="${rpt }" begin="63" end="66">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
                    <caption>【小六】过八成民校负责人认可的升学新评价</caption>
                    <c:forEach var="item" items="${rpt }" begin="67" end="72">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
                    <caption>校讯通公共账号点击情况</caption>
                    <c:forEach var="item" items="${rpt }" begin="73" end="76">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
