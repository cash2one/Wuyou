        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班校讯通家长用户<br>80后父母育儿观念六大特点盘点</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、二年级<br>我的孩子为何如此敏感脆弱？</caption>
                ...
                <table class="score-table">
                    <caption>小学三、四年级<br>别小看这十个“一分钟”</caption>
                ...
                <table class="score-table">
                    <caption>小学五年级<br>学习成绩的差距在于这12个习惯</caption>
                ...
                <table class="score-table">
                    <caption>小六<br>小升初考试中常出现的问题及应对办法</caption>
                ...
                <table class="score-table">
                    <caption>初一<br>教育孩子如此艰难，《虎妈猫爸》引热议</caption>
                ...
                <table class="score-table">
                    <caption>初二<br>提高学习成绩没有捷径,但有诀窍!</caption>
                ...
                <table class="score-table">
                    <caption>西安初三<br>今年西安近8.6万人中考，政策变化大</caption>
                ...
                <table class="score-table">
                    <caption>其他地市初三<br>中考“临阵磨枪”成绩层次不同方法也不同</caption>
                ...
                <table class="score-table">
                    <caption>高一<br>谢应平：九招激发孩子学习动力</caption>
                ...
                <table class="score-table">
                    <caption>高二<br>给高二准备上高三的人一些心里话！ </caption>
                ...
                <table class="score-table">
                    <caption>高三<br>最新出炉：陕西高考招生今年有三大变化！</caption>
                ...
                <%-- <table class="score-table">
                    <caption>高三<br>西安各校名师帮你赢在高考冲刺</caption>
                    <c:forEach var="item" items="${rpt }" begin="23" end="24">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
