    ...
    <div class="page-main">
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>总裁办</caption>
                    <c:forEach var="item" items="${rpt }" begin="1" end="4">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <%-- <table class="score-table">
                    ...
                    <c:forEach var="item" items="${rpt }" begin="7" end="7">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
                    ...
                    <c:forEach var="item" items="${rpt }" begin="8" end="8">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
                    ...
                    <c:forEach var="item" items="${rpt }" begin="9" end="9">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
