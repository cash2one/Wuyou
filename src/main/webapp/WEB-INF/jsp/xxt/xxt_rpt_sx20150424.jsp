        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班校讯通家长用户<br>震惊！电视原来对孩子的影响那么大！</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、二年级<br>家长，别让孩子的聪明毁在您的手里!</caption>
                ...
                <table class="score-table">
                    <caption>小学三、四年级<br>做个小孩不容易，听听孩子的心声吧！</caption>
                ...
                <table class="score-table">
                    <caption>小学五年级<br>孩子考试中的低级错误80%是家长造成的</caption>
                ...
                <table class="score-table">
                    <caption>小学六年级<br>考试技巧大放送！教你三招搞定小升初！</caption>
                ...
                <table class="score-table">
                    <caption>初一<br>知道了这些，初一数学根本不是个事！</caption>
                ...
                <table class="score-table">
                    <caption>初二<br>走进孩子内心的好方法！拿走不谢！</caption>
                ...
                <table class="score-table">
                    <caption>初三家长用户<br>中考冲刺：如何优化考场解题技巧</caption>
                ...
                <table class="score-table">
                    <caption>高一家长用户<br>高一语文考试得高分的答卷技巧 </caption>
                ...
                <table class="score-table">
                    <caption>高二家长用户<br>古诗歌鉴赏习惯用语，得高分不再是难题</caption>
                ...
                <table class="score-table">
                    <caption>高三家长用户<br>最后四十天，让二模告诉你孩子是什么型！   </caption>
