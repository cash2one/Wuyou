        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>80%家长会忽视的“初一衔接两大难关”</caption>
                ...
                <table class="score-table">
                    <caption>【中班】您真的知道孩子该读什么书吗？</caption>
                    <c:forEach var="item" items="${rpt }" begin="11" end="15">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
        		...
        		<table class="score-table">
                    <caption>校讯通公共账号点击情况</caption>
                    <c:forEach var="item" items="${rpt }" begin="16" end="18">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
                    <caption>【小二】治孩子“磨蹭病”的六大妙招</caption>
                    <c:forEach var="item" items="${rpt }" begin="19" end="23">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
        		...
        		<table class="score-table">
                    <caption>校讯通公共账号点击情况</caption>
                    <c:forEach var="item" items="${rpt }" begin="24" end="26">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
                    <caption>【小五】2015小升初制胜“面谈”六大技巧</caption>
                    <c:forEach var="item" items="${rpt }" begin="27" end="31">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
        		...
        		<table class="score-table">
                    <caption>校讯通公共账号点击情况</caption>
                    <c:forEach var="item" items="${rpt }" begin="32" end="34">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
                    <caption>【初一】最后一周提前学好物理的绝招</caption>
                    <c:forEach var="item" items="${rpt }" begin="35" end="39">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
        		...
        		<table class="score-table">
                    <caption>校讯通公共账号点击情况</caption>
                    <c:forEach var="item" items="${rpt }" begin="40" end="42">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
                    <caption>【初二】最后一周，三招教你预防 “初三病”</caption>
                ...
                <table class="score-table">
                    <caption>【初三】最后一周早看准，高中语文好“对付”</caption>
                ...
                <table class="score-table">
                    <caption>【高一】高二上学期，综合科难点先看清</caption>
                ...
                <table class="score-table">
                    <caption>【高二】高三教辅书，用错“害”高考</caption>
                    <c:forEach var="item" items="${rpt }" begin="67" end="71">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
        		...
        		<table class="score-table">
                    <caption>校讯通公共账号点击情况</caption>
                    <c:forEach var="item" items="${rpt }" begin="72" end="74">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
