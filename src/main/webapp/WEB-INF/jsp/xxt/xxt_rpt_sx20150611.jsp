        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班校讯通家长用户<br>一个问题，四种回答，四种命运！</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、二年级校讯通家长用户<br>手机夺走多少对孩子的爱，您“造”吗？</caption>
                ...
                <table class="score-table">
                    <caption>小学三、四年级校讯通家长用户<br>4招解决孩子学习走神、做事马虎</caption>
                ...
                <table class="score-table">
                    <caption>小学五年级校讯通家长用户<br>孩子学习时，聪明的家长该干嘛？</caption>
                ...
                <table class="score-table">
                    <caption>小学六年级校讯通家长用户<br>准初中生的学习生活，到底是“神马”？</caption>
                ...
                <table class="score-table">
                    <caption>初一年级校讯通家长用户<br>除忧，拼命，雄起！初一期末复习建议</caption>
                ...
                <table class="score-table">
                    <caption>初二年级校讯通家长用户<br>【新初三】学生进入之前必知七件事</caption>
                ...
                <table class="score-table">
                    <caption>初三年级校讯通家长用户<br>中考来临！公办、私立、国际高中如何抉择？</caption>
                ...
                <table class="score-table">
                    <caption>高一年级校讯通家长用户<br>高一考试成绩不稳定，不全是孩子的错！</caption>
                ...
                <table class="score-table">
                    <caption>高二年级校讯通家长用户<br>高二基础差，高三补回来！必须的！</caption>
                ...
                <table class="score-table">
                    <caption>高三年级校讯通家长用户<br>最新最全2015年山西省高考志愿填报流程！</caption>
                ...
                <table class="score-table">
                    <caption>各年级校讯通教师用户<br>别把自己累倒了！做个会“偷懒”的好老师</caption>
