        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班校讯通家长用户<br>暑假，陪孩子一起来玩创意小手工吧！</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、二年级校讯通家长用户<br>1334夸奖法则，教你夸出优秀孩子！</caption>
                ...
                <table class="score-table">
                    <caption>小学三、四年级校讯通家长用户<br>夏天孩子易上火，一吃就好的秘方</caption>
                ...
                <table class="score-table">
                    <caption>小学五年级校讯通家长用户<br>夏天孩子易上火，一吃就好的秘方</caption>
                ...
                <table class="score-table">
                    <caption>小学六年级校讯通家长用户<br>暑假中家长一定要给孩子补这4堂课！</caption>
                ...
                <table class="score-table">
                    <caption>初一年级校讯通家长用户<br>测测您是不是合格的初一家长</caption>
                ...
                <table class="score-table">
                    <caption>初二年级校讯通家长用户<br>文言文翻译技巧，准初三学生必备</caption>
                ...
                <table class="score-table">
                    <caption>初三年级校讯通家长用户<br>初三升高一，您知道衔接的重要性吗？</caption>
                ...
                <table class="score-table">
                    <caption>高一年级校讯通家长用户<br>掌握这5点，文化程度低也可以教出优等生</caption>
                ...
                <table class="score-table">
                    <caption>高二年级校讯通家长用户<br>没有做过这12件事，高中生活是不完美的</caption>
                ...
                <table class="score-table">
                    <caption>高三年级校讯通家长用户<br>哈佛学生是如何度过大学4年的？</caption>
                ...
                <table class="score-table">
                    <caption>各年级校讯通教师用户<br>暑假，各科老师去买车,销售居然疯了！</caption>
