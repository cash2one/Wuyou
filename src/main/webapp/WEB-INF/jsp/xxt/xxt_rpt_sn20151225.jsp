        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班<br>如何让宝宝更加自信，您必须了解</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、二年级<br>适合小学低年级学生的阅读书目推荐</caption>
                ...
                <table class="score-table">
                    <caption>小学三、四年级<br>让孩子速记英语单词的5大妙招</caption>
                ...
                <table class="score-table">
                    <caption>小学五、六年级<br>小学英语学习“难关”逐个破</caption>
                ...
                <table class="score-table">
                    <caption>初一<br>期末备考宝典之二：收藏！提高成绩的三大诀窍！</caption>
