        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>【校讯通】【初一】新初一，新难题：认识自我，重新定位</caption>
        		...
        		<%-- <table class="score-table">
                    <caption>【校园+】【初一】新初一，新难题：认识自我，重新定位</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【初二】初二全年成长历程大事件表</caption>
                    <c:forEach var="item" items="${rpt }" begin="3" end="4">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                ...
                <%-- <table class="score-table">
                    <caption>【校园+】【初二】初二全年成长历程大事件表</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【初三】初三必备：由始至终要坚守五大原则</caption>
               ...
               <%--  <table class="score-table">
                    <caption>【校园+】【初三】初三必备：由始至终要坚守五大原则</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【高一】2015-2016学年广东普通高中校历</caption>
                    <c:forEach var="item" items="${rpt }" begin="7" end="8">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                ...
                <%-- <table class="score-table">
                    <caption>【校园+】【高一】2015-2016学年广东普通高中校历</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【高二】2015-2016学年广东普通高中校历</caption>
                ...
                <%-- <table class="score-table">
                    <caption>【校园+】【高二】2015-2016学年广东普通高中校历</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【高三】面对新高考，如何选择合适的教辅书？</caption>
                ...
                <%-- <table class="score-table">
                    <caption>【校园+】【高三】面对新高考，如何选择合适的教辅书？</caption>
