        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>【高一】大学教授指路：从专业与就业看文理分科,,短信</caption>
                ...
                <table class="score-table">
                    <caption>【高一】大学教授指路：从专业与就业看文理分科,,消息</caption>
        		...
        		<table class="score-table">
                    <caption>【高二】高二期末，慎防“分化”,短信</caption>
                ...
                <table class="score-table">
                    <caption>【高二】高二期末，慎防“分化”,消息</caption>
        		...
        		<table class="score-table">
                    <caption>【高三】一轮复习后半段，补弱与增强并重,短信</caption>
                ...
                <table class="score-table">
                    <caption>【高三】一轮复习后半段，补弱与增强并重,消息</caption>
