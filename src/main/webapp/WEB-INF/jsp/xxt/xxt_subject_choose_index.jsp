        ...
        <div class="page-main">
            <article class="art">
                ...
                <section class="art-tips mb-20">
                    ...
                    <div class="aside ta-c">
                        <h3>登录校讯通APP，抢先获得测试卡密码</h3>
                        <p>1000个免费名额，先到先得！</p>
                    </div>
                </section>
                <section class="app-download">
                    <p class="title">未安装校讯通APP的用户，请点击以下按钮下载</p>
                    <a onclick="postEvent(this,'btnclick-download-ios','点击下载iPhone客户端');" href="http://120.197.89.182/release/app/ios/ios_intall.html" target="_blank" class="btn iphone"><span>校讯通iPhone版</span></a>
                    <a onclick="postEvent(this,'btnclick-download-android','点击下载安卓客户端');" href="http://120.197.89.182/release/app/android/3g.qq.com/GuangDongApp.apk" target="_blank" class="btn andriod"><span>校讯通Android版</span></a>
                </section>
            </article>
        </div>
