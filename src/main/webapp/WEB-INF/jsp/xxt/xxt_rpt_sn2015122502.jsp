        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>初二<br>班主任总结的历年考试前5名期末复习技巧</caption>
                ...
                <table class="score-table">
                    <caption>初三<br>“中考第一仗”之二：为何孩子很努力，但进步不明显</caption>
                ...
                <table class="score-table">
                    <caption>高一<br>文理分科之四大维度排排看</caption>
                ...
                <table class="score-table">
                    <caption>高二<br>警惕！莫让手机夺走了您孩子的好成绩</caption>
                ...
                <table class="score-table">
                    <caption>高三<br>期末大考冲刺之考试失利原因大揭秘</caption>
