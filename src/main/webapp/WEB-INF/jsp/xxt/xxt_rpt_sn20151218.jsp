        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班校讯通家长用户<br>孩子学写字的最佳时机</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、三年级<br>阅读时光之学会3招，做不打扰孩子阅读兴趣的家长！</caption>
                ...
                <table class="score-table">
                    <caption>小学四、五、六年级<br>孩子不爱学习的4大根源</caption>
                ...
                <table class="score-table">
                    <caption>初一<br>期末备考宝典之一：注意！考前必须戒掉的复习坏习惯</caption>
                ...
                <table class="score-table">
                    <caption>初二<br>期末备考宝典之一：如何带孩子走出“高原期”</caption>
                ...
                <table class="score-table">
                    <caption>初三<br>中考第一仗”之一：一日高效学习时间安排</caption>
                ...
                <table class="score-table">
                    <caption>高一<br>期末备考之盘点阻碍成绩提高的错误学习方法</caption>
                ...
                <table class="score-table">
                    <caption>高二<br>期末备考之盘点阻碍成绩提高的错误学习方法</caption>
                ...
                <table class="score-table">
                    <caption>高三<br>期末备考之盘点阻碍成绩提高的错误学习方法</caption>
