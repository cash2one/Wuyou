        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>【初一】走路上学成绩好！让人跌眼镜的提分奇招</caption>
               ...
               <table class="score-table">
                    <caption>【初二】走路上学成绩好！让人跌眼镜的提分奇招</caption>
                ...
                <table class="score-table">
                    <caption>【初三】走路上学成绩好！让人跌眼镜的提分奇招</caption>
                ...
                <table class="score-table">
                    <caption>【高一】华附名师：三招令期中复习事半功倍</caption>
                ...
                <table class="score-table">
                    <caption>【高二】华附名师：期中考是高二成绩“分水岭”</caption>
                    <c:forEach var="item" items="${rpt }" begin="35" end="40">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
                    <caption>校讯通公共账号点击情况</caption>
                    <c:forEach var="item" items="${rpt }" begin="41" end="44">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
                    <caption>【高三】华附名师：中段考快速提分“三步走”</caption>
                    <c:forEach var="item" items="${rpt }" begin="45" end="50">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
                    <caption>校讯通公共账号点击情况</caption>
                    <c:forEach var="item" items="${rpt }" begin="51" end="54">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
