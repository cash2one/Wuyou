        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班校讯通家长用户<br>育儿专家经验分享：我家宝宝的“起床神器”</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、二年级<br>注意：聪明孩子可能是“夸”出来的！</caption>
                ...
                <table class="score-table">
                    <caption>小学三、四、五、六年级<br>阻碍成绩提高的错误学习方法大盘点</caption>
                ...
                <table class="score-table">
                    <caption>初一<br>看《新初一家长普遍面临的四大难题</caption>
                ...
                <table class="score-table">
                    <caption>初二<br>名师分享：让孩子成绩好起来，其实很简单！</caption>
                ...
                <table class="score-table">
                    <caption>初三<br>期中考不理想，家长仍可帮初三生这样打个“翻身仗”</caption>
                ...
                <table class="score-table">
                    <caption>高一<br>期中考后这样做，可提高期末考成绩</caption>
                ...
                <table class="score-table">
                    <caption>高二<br>名校尖子来支招：期中考不理想原因大分析！</caption>
                ...
                <table class="score-table">
                    <caption>高三<br>学霸支招：考后要能这样做，一模前必变尖子！</caption>
