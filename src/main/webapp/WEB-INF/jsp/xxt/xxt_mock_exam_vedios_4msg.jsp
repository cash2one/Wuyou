...
<img src="<%=basePath%>/xxtStat/addRecordV2.do?action=page-enter-vedio&${ queryStr }" width="0" height="0" style="display: none;"/>
...
$(function(){
	$("#btn_android").click(function(){
		postUserActionRecordV2("<%=basePath%>", 'btnclick-dowload-android', "${ queryStr }");
	});
	
	$("#btn_ios").click(function(){
		postUserActionRecordV2("<%=basePath%>", 'btnclick-dowload-ios', "${ queryStr }");
	});
...
<div id="page">
    ...
    <div class="page-main mt-0">
        ...
        <div class="r-sms-down">
            <h3>获取全科华附名师讲解视频<br>请下载校讯通APP</h3>
            <a id="btn_ios" href="http://120.197.89.182/release/app/ios/ios_intall.html" target="_blank" class="iphone"><span>校讯通iPhone版</span></a>
            <a id="btn_android" href="http://120.197.89.182/release/app/android/3g.qq.com/GuangDongApp.apk" target="_blank" class="andriod"><span>校讯通Android版</span></a>
        </div>
        <br>
        <div class="ta-c">
            <h3>为了更流畅的观看效果，<br>您也可以在电脑上打开以下网址</h3>
