        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班校讯通家长用户<br>假期将至，您的孩子能避开危险吗？</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、二年级校讯通家长用户<br>这个暑假你准备让孩子怎么过？</caption>
                ...
                <table class="score-table">
                    <caption>小学三、四年级校讯通家长用户<br>父母缺少这三样，是教育不好孩子的！</caption>
                ...
                <table class="score-table">
                    <caption>小学五年级校讯通家长用户<br>表扬孩子也有公式，家长您做对了吗？</caption>
                ...
                <table class="score-table">
                    <caption>小学六年级校讯通家长用户<br>小升初暑假入门政治、历史学习攻略</caption>
                ...
                <table class="score-table">
                    <caption>初一年级校讯通家长用户<br>送给初一孩子完美的暑假计划</caption>
                ...
                <table class="score-table">
                    <caption>初二年级校讯通家长用户<br>为什么家长越“不管”，孩子成绩越好</caption>
                ...
                <table class="score-table">
                    <caption>初三年级校讯通家长用户<br>家长该如何面对孩子的中考（成绩）</caption>
                ...
                <table class="score-table">
                    <caption>高一年级校讯通家长用户<br>高二新“学员”，如何过暑假</caption>
                ...
                <table class="score-table">
                    <caption>高二年级校讯通家长用户<br>他用脚考了603分，你还有什么资格不努力？</caption>
                ...
                <table class="score-table">
                    <caption>高三年级校讯通家长用户<br>高考“红牌、黄牌、绿牌”专业大集合</caption>
                ...
                <table class="score-table">
                    <caption>各年级校讯通教师用户<br>成为一名合格老师，这些细节你做到了吗？</caption>
