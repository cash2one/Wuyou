        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班校讯通家长用户<br>5个月做好幼升小的准备</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、2年级<br>新学期，被“拐走”的孩子咋收心</caption>
                ...
                <table class="score-table">
                    <caption>小学三、4年级<br>新学期，被“拐走”的孩子咋收心</caption>
                ...
                <table class="score-table">
                    <caption>小学五年级<br>任性的奥数培训选择！到了关键时刻我们选不选奥数</caption>
                ...
                <table class="score-table">
                    <caption>小学六年级<br>2015太原小升初择校要注意七件事</caption>
                ...
                <table class="score-table">
                    <caption>初一、2家长用户<br>初中生青春期问题来了！压岁钱去哪了？！</caption>
                ...
                <table class="score-table">
                    <caption>初三家长用户<br>中考发展方向早知道</caption>
                ...
                <table class="score-table">
                    <caption>高一家长用户<br>2017年高考课改来临，我们怎么办？</caption>
                ...
                <table class="score-table">
                    <caption>高三家长推送<br>状元教您“一模”每科如何至少提十分！</caption>
