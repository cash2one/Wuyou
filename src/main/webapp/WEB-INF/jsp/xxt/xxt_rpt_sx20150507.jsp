        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班校讯通家长用户<br>听！原来孩子对妈妈有这么多甜蜜的抱怨！</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、二年级<br>每天抽10个“1分钟”，教育效果难以想像！</caption>
                ...
                <table class="score-table">
                    <caption>小学三、四年级<br>绝对是挑战！家长答不过孩子的5道思维题！</caption>
                ...
                <table class="score-table">
                    <caption>小学五年级<br>8大妙招让孩子拥有出众记忆力！</caption>
                ...
                <table class="score-table">
                    <caption>小学六年级<br>不得不看的全新2015山西省小升初政策!</caption>
                ...
                <table class="score-table">
                    <caption>初一<br>英语单词背诵秘诀，送给初一的你！</caption>
                ...
                <table class="score-table">
                    <caption>初二<br>行动吧！别等初二两极分化，初三天上地下！</caption>
                ...
                <table class="score-table">
                    <caption>初三家长用户<br>中考最后40天，家长应扮演的四种角色</caption>
                ...
                <table class="score-table">
                    <caption>高一家长用户<br>高一晚上这么学，绝对“逆袭”上清华！ </caption>
                ...
                <table class="score-table">
                    <caption>高二家长用户<br>期末考试九大抢分“武功秘技”</caption>
                ...
                <table class="score-table">
                    <caption>高三家长用户<br>一般人不知道的高考阅卷大秘密！ </caption>
