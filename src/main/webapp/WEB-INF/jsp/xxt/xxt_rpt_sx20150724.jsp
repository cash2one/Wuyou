        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班校讯通家长用户<br>为新一年级家长解除焦虑的6个小妙招</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、二年级校讯通家长用户<br>家长课堂：“富养”孩子可能忽略的底线</caption>
                ...
                <table class="score-table">
                    <caption>小学三、四年级校讯通家长用户<br>小学生十项习惯的培养细则</caption>
                ...
                <table class="score-table">
                    <caption>小学五年级校讯通家长用户<br>千万别这样叫孩子起床！不是闹着玩</caption>
                ...
                <table class="score-table">
                    <caption>小学六年级校讯通家长用户<br>孩子暑假圈养or教养or放养均不足取</caption>
                ...
                <table class="score-table">
                    <caption>初一年级校讯通家长用户<br>初一家长必读：最佳的人生教育时期排列</caption>
                ...
                <table class="score-table">
                    <caption>初二年级校讯通家长用户<br>全球公认的最健康作息时间表，送给您</caption>
                ...
                <table class="score-table">
                    <caption>初三年级校讯通家长用户<br>孩子即将升入高中，如何迈进尖子生行列</caption>
                ...
                <table class="score-table">
                    <caption>高一年级校讯通家长用户<br>孩子是您亲生的，但为什么您说话他总不听</caption>
                ...
                <table class="score-table">
                    <caption>高二年级校讯通家长用户<br>2015年暑假须知：高考复习备考需稳中求进</caption>
                ...
                <table class="score-table">
                    <caption>高三年级校讯通家长用户<br>致准大学生：大学这样过，不失业，天造孽！</caption>
                ...
                <table class="score-table">
                    <caption>各年级校讯通教师用户<br>老师如何与90、00后新新人类相处</caption>
