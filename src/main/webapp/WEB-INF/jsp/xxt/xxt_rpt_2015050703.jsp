        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>【小四】从名校开放日提前准备小升初,短信</caption>
                ...
                <table class="score-table">
                    <caption>【小四】从名校开放日提前准备小升初,消息</caption>
        		...
        		<table class="score-table">
                    <caption>【小五】从名校开放日提前准备小升初,短信</caption>
                ...
                <table class="score-table">
                    <caption>【小五】从名校开放日提前准备小升初,消息</caption>
        		...
        		<table class="score-table">
                    <caption>【初三】广州市高中名校重点班报考指南,短信</caption>
                ...
                <table class="score-table">
                    <caption>【初三】广州市高中名校重点班报考指南,消息</caption>
