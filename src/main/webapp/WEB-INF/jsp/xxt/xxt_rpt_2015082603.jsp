        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>【校讯通】【初一】新初二学生开学必备20件“利器”</caption>
        		...
        		<%-- <table class="score-table">
                    <caption>【校园+】【初一】新初二学生开学必备20件“利器”</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【初二】新中考生开学必备20件“利器”</caption>
                    <c:forEach var="item" items="${rpt }" begin="3" end="4">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                ...
                <%-- <table class="score-table">
                    <caption>【校园+】【初二】新中考生开学必备20件“利器”</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【初三】新高一学生如何快速跟上高中学习节奏</caption>
                ...
                <%-- <table class="score-table">
                    <caption>【校园+】【初三】新高一学生如何快速跟上高中学习节奏</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【高一】高二上学期，综合科难点先看清</caption>
                    <c:forEach var="item" items="${rpt }" begin="7" end="8">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                ...
                <%-- <table class="score-table">
                    <caption>【校园+】【高一】高二上学期，综合科难点先看清</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【高二】面对新高考，如何选择合适的教辅书？</caption>
                ...
                <%-- <table class="score-table">
                    <caption>【校园+】【高二】面对新高考，如何选择合适的教辅书？</caption>
