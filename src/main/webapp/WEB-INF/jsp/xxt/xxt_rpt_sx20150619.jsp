        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班校讯通家长用户<br>“不生气的妈妈”是给孩子最大的幸福！</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、二年级校讯通家长用户<br>Mom，您换个态度，我的未来将天壤之别！</caption>
                ...
                <table class="score-table">
                    <caption>小学三、四年级校讯通家长用户<br>您是孩子的“地板”还是“天花板”？</caption>
                ...
                <table class="score-table">
                    <caption>小学五年级校讯通家长用户<br>五年级家长早知道: 小学与初中学习的差异</caption>
                ...
                <table class="score-table">
                    <caption>小学六年级校讯通家长用户<br>太原小升初政策公布：公参民学校70%自主招生</caption>
                ...
                <table class="score-table">
                    <caption>初一年级校讯通家长用户<br>孩子最大的敌人就是——别人家的孩子</caption>
                ...
                <table class="score-table">
                    <caption>初二年级校讯通家长用户<br>学生和家长头疼的五（有）句（不）话（同）</caption>
                ...
                <table class="score-table">
                    <caption>初三年级校讯通家长用户<br>2015中考必知,快来围观！</caption>
                ...
                <table class="score-table">
                    <caption>高一年级校讯通家长用户<br>高一期末不得不知的备考“必杀”技!</caption>
                ...
                <table class="score-table">
                    <caption>高二年级校讯通家长用户<br>【准高三】必读暑假安排，一轮复习先人一步</caption>
                ...
                <table class="score-table">
                    <caption>高三年级校讯通家长用户<br>高考填报志愿五大误区，您躲过了吗？</caption>
                ...
                <table class="score-table">
                    <caption>各年级校讯通教师用户<br>期末临近，开好家长会的四大“绝密武器”</caption>
