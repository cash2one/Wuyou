        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班校讯通家长用户<br>7岁前让孩子学规矩</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、二年级校讯通家长用户<br>孩子必须懂的25条礼貌规则</caption>
                ...
                <table class="score-table">
                    <caption>小学三、四年级校讯通家长用户<br>小学三、四年级：如何培养孩子的基础学习？</caption>
                ...
                <table class="score-table">
                    <caption>小学五年级校讯通家长用户<br>小升初暑假备战：小学生必知的科普知识</caption>
                ...
                <table class="score-table">
                    <caption>小学六年级校讯通家长用户<br>孩子小学成绩差，就会一直差吗？</caption>
                ...
                <table class="score-table">
                    <caption>初一年级校讯通家长用户<br>作为家长，你越狠，孩子越强！</caption>
                ...
                <table class="score-table">
                    <caption>初二年级校讯通家长用户<br>【超实用】初中数学思维导图！</caption>
                ...
                <table class="score-table">
                    <caption>初三年级校讯通家长用户<br>新高一压力大，适应能力差，怎么办？</caption>
                ...
                <table class="score-table">
                    <caption>高一年级校讯通家长用户<br>聪明的家长如何辅导高中孩子</caption>
                ...
                <table class="score-table">
                    <caption>高二年级校讯通家长用户<br>新高三，你准备好迎战2016高考了吗？</caption>
                ...
                <table class="score-table">
                    <caption>各年级校讯通教师用户<br>【师道】透给教师的十点“伎俩”</caption>
