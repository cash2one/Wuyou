        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>【小四】大汇总！2015小升初名校面谈内容一览,短信</caption>
                ...
                <table class="score-table">
                    <caption>【小四】大汇总！2015小升初名校面谈内容一览,消息</caption>
        		...
        		<table class="score-table">
                    <caption>【小五】大汇总！2015小升初名校面谈内容一览,短信</caption>
                ...
                <table class="score-table">
                    <caption>【小五】大汇总！2015小升初名校面谈内容一览,消息</caption>
        		...
        		<table class="score-table">
                    <caption>【初三】新高一暑期系列——军训后如何“华丽转身”至高中学习？,短信</caption>
                ...
                <table class="score-table">
                    <caption>【初三】新高一暑期系列——军训后如何“华丽转身”至高中学习？,消息</caption>
                ...
                <table class="score-table">
                    <caption>【高二】做合格高三家长，从8月区调研考开始,短信</caption>
                ...
                <table class="score-table">
                    <caption>【高二】做合格高三家长，从8月区调研考开始,消息</caption>
                ...
                <table class="score-table">
                    <caption>【小六】新初一生须知的广州中考概况</caption>
                ...
                <table class="score-table">
                    <caption>【小六】新初一生须知的广州中考概况</caption>
                    <c:forEach var="item" items="${rpt }" begin="43" end="44">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
