        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班校讯通家长用户<br>褒贬不一的《弟子规》，宝贝该读吗？</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、2年级<br>做个不讲道理的家长？ 太对了！</caption>
                ...
                <table class="score-table">
                    <caption>小学三、四年级<br>99%的家长给孩子检查作业都用错了方式</caption>
                ...
                <table class="score-table">
                    <caption>小学五年级<br>小升初阅读理解考试技巧总结</caption>
                ...
                <table class="score-table">
                    <caption>小学六年级<br>小升初阅读理解考试技巧总结</caption>
                ...
                <table class="score-table">
                    <caption>初一<br>青春期孩子沟通三大痛点（一）</caption>
                ...
                <table class="score-table">
                    <caption>初二<br>初二下学期学生学习应注意些什么？</caption>
                ...
                <table class="score-table">
                    <caption>初三家长用户<br>2015年太原中考体育有关事项通知</caption>
                ...
                <table class="score-table">
                    <caption>高一家长用户<br>让孩子成为狼一样的强者</caption>
                ...
                <table class="score-table">
                    <caption>高二家长用户<br>门槛提高了，政策收紧了，你还想参加艺考吗?</caption>
                ...
                <table class="score-table">
                    <caption>高三家长用户<br>一个“差生”冲击高考一本的成功经验！</caption>
