        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>【校讯通】【初一】孩子干家务应付工资吗？看专家怎么说</caption>
        		...
        		<%-- <table class="score-table">
                    <caption>【校园+】【初一】孩子干家务应付工资吗？看专家怎么说</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【初二】准初三生暑假期间如何轻松逆袭？</caption>
                    <c:forEach var="item" items="${rpt }" begin="3" end="4">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
               ...
               <%--  <table class="score-table">
                    <caption>【校园+】【初二】准初三生暑假期间如何轻松逆袭？</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【初三】初升高|学生须知的英语科巨大变化</caption>
                ...
                <%-- <table class="score-table">
                    <caption>【校园+】【初三】初升高|学生须知的英语科巨大变化</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【高一】作为一个合格的文/理科生，你需要知道这些！</caption>
                    <c:forEach var="item" items="${rpt }" begin="7" end="8">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                ...
                <%-- <table class="score-table">
                    <caption>【校园+】【高一】作为一个合格的文/理科生，你需要知道这些！</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【高二】新高三必看！2016高考全年大事表</caption>
                ...
                <%-- <table class="score-table">
                    <caption>【校园+】【高二】新高三必看！2016高考全年大事表</caption>
