        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>【校讯通】【初一】“初二现象”，您了解吗？</caption>
        		...
        		<%-- <table class="score-table">
                    <caption>【校园+】【初一】“初二现象”，您了解吗？</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【初二】2016年中考生必备:初三学年大事记</caption>
                    <c:forEach var="item" items="${rpt }" begin="3" end="4">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                ...
                <%-- <table class="score-table">
                    <caption>【校园+】【初二】2016年中考生必备:初三学年大事记</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【初三】经验之谈:“高三党”给准高一新生的建议</caption>
                ...
                <%-- <table class="score-table">
                    <caption>【校园+】【初三】经验之谈:“高三党”给准高一新生的建议</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【高一】高二上学期数学、英语“雷区“提早知</caption>
                    <c:forEach var="item" items="${rpt }" begin="7" end="8">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                ...
                <%-- <table class="score-table">
                    <caption>【校园+】【高一】高二上学期数学、英语“雷区“提早知</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【高二】2015高考省内外高校录取格局变化解析</caption>
               ...
               <%--  <table class="score-table">
                    <caption>【校园+】【高二】2015高考省内外高校录取格局变化解析</caption>
