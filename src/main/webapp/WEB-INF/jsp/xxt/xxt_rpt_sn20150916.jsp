        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班校讯通家长用户<br>我曾经是如此嫌弃自己孩子…</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、二年级<br>大家支招学拼音</caption>
                ...
                <table class="score-table">
                    <caption>小学三、四年级<br>孩子班级按成绩排座位你怎么看？</caption>
                ...
                <table class="score-table">
                    <caption>小学五、六年级<br>白岩松：我从不让儿子考第一！</caption>
                ...
                <table class="score-table">
                    <caption>初一<br>教师节：老师也烦“被收礼”</caption>
                ...
                <table class="score-table">
                    <caption>初二<br>【焦点话题】让孩子少玩手机电脑的有效方法</caption>
                ...
                <table class="score-table">
                    <caption>初三<br>开学季，新初三同学必须做好8项学习管理</caption>
                ...
                <table class="score-table">
                    <caption>高一<br>如何拉近我们和孩子之间的距离？</caption>
                ...
                <table class="score-table">
                    <caption>高二<br>怎样制定属于自己的学习计划</caption>
                ...
                <table class="score-table">
                    <caption>高三<br>最新鲜出炉：2015年高考状元调查报告</caption>
