    ...
    <div class="page-main">
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>【小二】培养孩子优秀学习习惯——妈妈要学会“放手”</caption>
                ...
                <table class="score-table">
                    <caption>【小五】2014年小升初录取分数线一览</caption>
                ...
                <table class="score-table">
                    <caption>【小六】升上初中后，学生须知的语文科变化</caption>
                ...
                <table class="score-table">
                    <caption>【初一】两成中学生早恋，家长怎么办</caption>
                ...
                <table class="score-table">
                    <caption>【初二】广州各区名校特色大盘点</caption>
