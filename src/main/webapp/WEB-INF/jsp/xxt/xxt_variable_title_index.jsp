...
<script type="text/javascript">
	_hmt.push(['_setCustomVar', 1, 'INFO_1', '${cityId }', 1]);
        ...
        <div class="page-main">
            <article class="index-art">
                ...
                <section>
                    ...
                    <!-- <a href="javascript:void(0);" class="s-red-btn btn-open-app">打开校讯通app，获取我的变式题</a> -->
                    <div class="app-download">
                        <p class="title">未安装校讯通APP的用户，请点击一下按钮下载</p>
                        <a onclick="postEvent(this,'btnclick-download-ios','点击下载iPhone客户端');" href="http://120.197.89.182/release/app/ios/ios_intall.html" target="_blank" class="iphone"><span>校讯通iPhone版</span></a>
                        <a onclick="postEvent(this,'btnclick-download-android','点击下载安卓客户端');" href="http://120.197.89.182/release/app/android/3g.qq.com/GuangDongApp.apk" target="_blank" class="andriod"><span>校讯通Android版</span></a>
                    </div>
                </section>
            </article>
        </div>
