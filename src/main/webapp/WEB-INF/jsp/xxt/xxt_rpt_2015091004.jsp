        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>【校讯通】【初二】初二承上启下关键期，提前树立中考概念</caption>
        		...
        		<%-- <table class="score-table">
                    <caption>【校园+】【初二】初二承上启下关键期，提前树立中考概念</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【初三】中考状元的听课法宝</caption>
                    <c:forEach var="item" items="${rpt }" begin="3" end="4">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
               ...
               <%--  <table class="score-table">
                    <caption>【校园+】【初三】中考状元的听课法宝</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【高一】高中老师告诉您，新高一各科这样学</caption>
               ...
               <%--  <table class="score-table">
                    <caption>【校园+】【高一】高中老师告诉您，新高一各科这样学</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【高二】9.3大阅兵中透露出来的高中考试热点</caption>
                    <c:forEach var="item" items="${rpt }" begin="7" end="8">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                ...
                <%-- <table class="score-table">
                    <caption>【校园+】【高二】9.3大阅兵中透露出来的高中考试热点</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【高三】从9.3大阅兵中透露出来的高考热点</caption>
               ...
               <%--  <table class="score-table">
                    <caption>【校园+】【高三】从9.3大阅兵中透露出来的高考热点</caption>
