        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班校讯通家长用户<br>孩子成长的关键期，父母,你该做什么？</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、二年级校讯通家长用户<br>饭桌上的中国孩子、美国孩子和韩国孩子</caption>
                ...
                <table class="score-table">
                    <caption>小学三、四年级校讯通家长用户<br>五种“个性”父母对孩子成长的影响！</caption>
                ...
                <table class="score-table">
                    <caption>小学五年级校讯通家长用户<br>为小升初语文写作打基础的6大技巧</caption>
                ...
                <table class="score-table">
                    <caption>小学六年级校讯通家长用户<br>请不要触及孩子的六大底线</caption>
                ...
                <table class="score-table">
                    <caption>初一年级校讯通家长用户<br>初一到初二，孩子学习成绩的突变期！</caption>
                ...
                <table class="score-table">
                    <caption>初二年级校讯通家长用户<br>初三这一年，学习和生活应该是这样的！</caption>
                ...
                <table class="score-table">
                    <caption>初三年级校讯通家长用户<br>初三→高一，别把生物不当回事儿</caption>
                ...
                <table class="score-table">
                    <caption>高一年级校讯通家长用户<br>习大大期望高中生具备的六种品质！</caption>
                ...
                <table class="score-table">
                    <caption>高二年级校讯通家长用户<br>北京赢了！冬奥会将带火哪些大学专业</caption>
                ...
                <table class="score-table">
                    <caption>各年级校讯通教师用户<br>老师的假期究竟挡了谁的路？</caption>
