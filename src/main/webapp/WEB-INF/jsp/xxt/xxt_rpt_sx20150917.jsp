        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>小学一、二年级校讯通家长用户<br>孩子为什么近视？这些视力杀手你都知道吗！</caption>
        		...
        		<table class="score-table">
                    <caption>小小学三、四年级校讯通家长用户<br>【山西】浅谈奥数学习的存在意义，力荐！</caption>
                ...
                <table class="score-table">
                    <caption>小学五、六年级校讯通家长用户<br>【小升初】七大主要升学途径优缺点揭秘</caption>
                ...
                <table class="score-table">
                    <caption>初一、初二年级校讯通家长用户<br>中学生，你要手机做什么?</caption>
                ...
                <table class="score-table">
                    <caption>太原市初三年级校讯通家长用户<br>2016太原中考：新初三学生的五大通病</caption>
                ...
                <table class="score-table">
                    <caption>高一、高二年级校讯通家长用户<br>高中学生选择参考书必知的那些事儿</caption>
                ...
                <table class="score-table">
                    <caption>高三年级校讯通家长用户<br>【学习干货】高三数学一轮复习如何逆袭？</caption>
                ...
                <table class="score-table">
                    <caption>各年级校讯通教师用户<br>老师，您再也不用声嘶力竭了！</caption>
