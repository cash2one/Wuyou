        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>【初一】初中常考景点，暑假你会带孩子去几个？,短信</caption>
                ...
                <table class="score-table">
                    <caption>【初一】初中常考景点，暑假你会带孩子去几个？,消息</caption>
        		...
        		<table class="score-table">
                    <caption>【初二】初中常考景点，暑假你会带孩子去几个？,短信</caption>
                ...
                <table class="score-table">
                    <caption>【初二】初中常考景点，暑假你会带孩子去几个？,消息</caption>
        		...
        		<table class="score-table">
                    <caption>【初三】初中常考景点，暑假你会带孩子去几个？,短信</caption>
                ...
                <table class="score-table">
                    <caption>【初三】初中常考景点，暑假你会带孩子去几个？,消息</caption>
                ...
                <table class="score-table">
                    <caption>【高一】华附名师：文/理科生的学习能力要求,短信</caption>
                ...
                <table class="score-table">
                    <caption>【高一】华附名师：文/理科生的学习能力要求,消息</caption>
                 ...
                 <table class="score-table">
                    <caption>【高二】2016高考“全国卷”语文变难怎么破,短信</caption>
                ...
                <table class="score-table">
                    <caption>【高二】2016高考“全国卷”语文变难怎么破,消息</caption>
