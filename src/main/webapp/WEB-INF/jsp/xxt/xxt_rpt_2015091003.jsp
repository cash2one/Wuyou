        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>【校讯通】【小班】【中班】【大班】教师节调查：幼儿园老师喜欢什么样的父母？</caption>
        		...
        		<%-- <table class="score-table">
                    <caption>【校园+】【小班】【中班】【大班】教师节调查：幼儿园老师喜欢什么样的父母？</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【小一】【小二】小学一二年级如何进行高质量“陪读”？</caption>
                    <c:forEach var="item" items="${rpt }" begin="3" end="4">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                ...
                <%-- <table class="score-table">
                    <caption>【校园+】【小一】【小二】小学一二年级如何进行高质量“陪读”？</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【小三】【小四】孩子开学没状态，沉迷电视网络咋办？</caption>
               ...
               <%--  <table class="score-table">
                    <caption>【校园+】【小三】【小四】孩子开学没状态，沉迷电视网络咋办？</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【小五】【小六】让孩子做到自主作业，并不难！</caption>
                    <c:forEach var="item" items="${rpt }" begin="7" end="8">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                ...
                <%-- <table class="score-table">
                    <caption>【校园+】【小五】【小六】让孩子做到自主作业，并不难！</caption>
                ...
                <table class="score-table">
                    <caption>【校讯通】【初一】九月要务：两脚着地，练好四大基本功</caption>
                ...
                <%-- <table class="score-table">
                    <caption>【校园+】【初一】九月要务：两脚着地，练好四大基本功</caption>
