        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班校讯通家长用户<br>6张连环画揭秘宝宝生气为何越哄越哭</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、二年级<br>旅行能长见识？我该不该带你去旅行</caption>
                ...
                <table class="score-table">
                    <caption>小学三、四年级<br>孩子写作业慢的6种原因，你家孩子属于哪种？</caption>
                ...
                <table class="score-table">
                    <caption>小学五年级<br>11岁的孩子不喜欢上学，看专家是怎么点评</caption>
                ...
                <table class="score-table">
                    <caption>小学六年级<br>鼓励和表扬原来完全不同！</caption>
                ...
                <table class="score-table">
                    <caption>初一<br>初一下学期成绩最容易下滑的三类孩子</caption>
                ...
                <table class="score-table">
                    <caption>初二<br>进入初三前，我们应具备的品质</caption>
                ...
                <table class="score-table">
                    <caption>初三家长用户<br>中考生最反感的27句话，今天你说了几句</caption>
                ...
                <table class="score-table">
                    <caption>高一家长用户<br>开学这么久，你和孩子聊过吗？</caption>
                ...
                <table class="score-table">
                    <caption>高二家长用户<br>高中数学：我是如何从44分到127分的</caption>
                ...
                <table class="score-table">
                    <caption>高三家长用户<br>高考10天提高50分，体验高效学习方法</caption>
