        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班校讯通家长用户<br>真实案例：强迫宝宝认字，小学后成绩反后退</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、二年级<br>小学生作业问题解决办法大全</caption>
                ...
                <table class="score-table">
                    <caption>小学三、四、五、六年级<br>影响孩子成绩的第一要素竟是父母的行为！</caption>
                ...
                <table class="score-table">
                    <caption>初一<br>提高语文成绩，居然有33种方法！</caption>
                ...
                <table class="score-table">
                    <caption>初二<br>教您怎么做个心平气和的叛逆期孩子家长</caption>
                ...
                <table class="score-table">
                    <caption>初三<br>不会与孩子沟通时，初三家长不妨写书信</caption>
                ...
                <table class="score-table">
                    <caption>高一<br>名校独创 “五连环”学习法</caption>
                ...
                <table class="score-table">
                    <caption>高二<br>名校独创 “五连环”学习法</caption>
                ...
                <table class="score-table">
                    <caption>高三<br>名师教你做好高三各场考试总结，快速提分！</caption>
