        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>【初三】中考后逆袭的唯一方法,短信</caption>
                ...
                <table class="score-table">
                    <caption>【初三】中考后逆袭的唯一方法,消息</caption>
        		...
        		<table class="score-table">
                    <caption>【高一】期末考家长必做的“两手准备”,短信</caption>
                ...
                <table class="score-table">
                    <caption>【高一】期末考家长必做的“两手准备”,消息</caption>
        		...
        		<table class="score-table">
                    <caption>【高二】期末考家长必做的“两手准备”,短信</caption>
                ...
                <table class="score-table">
                    <caption>【高二】期末考家长必做的“两手准备”,消息</caption>
                ...
                <table class="score-table">
                    <caption>【高三】绝地反击！高考失意生的最后一条逆袭路,短信</caption>
                ...
                <table class="score-table">
                    <caption>【高三】绝地反击！高考失意生的最后一条逆袭路,消息</caption>
