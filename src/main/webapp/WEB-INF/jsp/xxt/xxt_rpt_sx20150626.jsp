        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班校讯通家长用户<br>不打不骂，用讲故事的方式让孩子乖乖听话！</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、二年级校讯通家长用户<br>暑假增进亲子关系的5大关键时间！</caption>
                ...
                <table class="score-table">
                    <caption>小学三、四年级校讯通家长用户<br>各种让孩子爱上写作业的秘诀，第N个亮眼！</caption>
                ...
                <table class="score-table">
                    <caption>小学五年级校讯通家长用户<br>五年级家长：您的不经意，影响孩子一辈子！</caption>
                ...
                <table class="score-table">
                    <caption>小学六年级校讯通家长用户<br>小升初家长必须思考的十大关键问题</caption>
                ...
                <table class="score-table">
                    <caption>初一年级校讯通家长用户<br>初二是成绩的分水岭，这套方法太重要了</caption>
                ...
                <table class="score-table">
                    <caption>初二年级校讯通家长用户<br>上初三后应该怎么学?</caption>
                ...
                <table class="score-table">
                    <caption>初三年级校讯通家长用户<br>中考结束后，你应该告诉孩子的三件事</caption>
                ...
                <table class="score-table">
                    <caption>高一年级校讯通家长用户<br>提分利器！不可不看的语数外期末复习法宝</caption>
                ...
                <table class="score-table">
                    <caption>高二年级校讯通家长用户<br>提分利器！不可不看的语数外期末复习法宝</caption>
                ...
                <table class="score-table">
                    <caption>高三年级校讯通家长用户<br>高考志愿填报时需绕过的四个坑！</caption>
                ...
                <table class="score-table">
                    <caption>各年级校讯通教师用户<br>校讯通App--界面栏目功能简介！</caption>
