        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>立足个人兴趣和学习能力找准专业方向</caption>
                    <c:forEach var="item" items="${rpt }" begin="0" end="12">
                    	<tr>
                ...
                <table class="score-table">
                    <caption>立足个人兴趣和学习能力找准专业方向</caption>
                    <c:forEach var="item" items="${rpt }" begin="21" end="32">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
                    <caption>校讯通公共账号点击情况</caption>
                    <c:forEach var="item" items="${rpt }" begin="33" end="40">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
                    <caption>立足个人兴趣和学习能力找准专业方向</caption>
                    <c:forEach var="item" items="${rpt }" begin="41" end="52">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
                ...
                <table class="score-table">
                    <caption>校讯通公共账号点击情况</caption>
                    <c:forEach var="item" items="${rpt }" begin="53" end="60">
                    	<tr>
		                	<th style="width: 70%">${item.key }</th>
	                        <td><strong>${item.value }</strong></td>
                    	</tr>
