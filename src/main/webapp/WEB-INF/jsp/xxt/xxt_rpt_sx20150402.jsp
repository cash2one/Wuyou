        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>幼儿园小班、中班、大班校讯通家长用户<br>Duang!囧孩子的各种状况，你敢接招吗？</caption>
        		...
        		<table class="score-table">
                    <caption>小学一、二年级<br>这样做！以后再也不用担心孩子读书了</caption>
                ...
                <table class="score-table">
                    <caption>小学三、四年级<br>智慧营养从书中获取</caption>
                ...
                <table class="score-table">
                    <caption>小学五年级<br>五年级，孩纸正在变化你造吗？赶紧看看吧</caption>
                ...
                <table class="score-table">
                    <caption>小学六年级<br>小升初在即，什么是“最好”的初中？</caption>
                ...
                <table class="score-table">
                    <caption>初一<br>想要孩子理智“追星”家长也要理智</caption>
                ...
                <table class="score-table">
                    <caption>初二<br>叛逆是好的开始，看懂的家长孩子有救了！</caption>
                ...
                <table class="score-table">
                    <caption>初三家长用户<br>是谁“抢”走了孩子考高分的机会</caption>
                ...
                <table class="score-table">
                    <caption>高一家长用户<br>规律学习------四遍＞四轮</caption>
                ...
                <table class="score-table">
                    <caption>高二家长用户<br>尖子生的下学期原来这样安排的，一起看看吧</caption>
                ...
                <table class="score-table">
                    <caption>高三家长用户<br>对抗“脑疲劳”，高三需谨慎 </caption>
