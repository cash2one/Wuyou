        ...
        <article class="analy-item">
        	<section style="padding:2px;">
        		...
        		<table class="score-table">
                    <caption>家长课堂之表扬与惩罚，分寸拿捏不好影响孩子一生</caption>
        		...
        		<table class="score-table">
                    <caption>期末备考系列之考前如何指导孩子做作业</caption>
                ...
                <table class="score-table">
                    <caption>期末冲刺系列之这样复习语文，成绩最少提高10分！</caption>
                ...
                <table class="score-table">
                    <caption>期末备考宝典之三：如何短时间复习多抢30多分</caption>
                ...
                <table class="score-table">
                    <caption>初三期末考试五大科目复习攻略</caption>
                ...
                <table class="score-table">
                    <caption>文理分科指导之从大学专业与就业选科</caption>
                ...
                <table class="score-table">
                    <caption>期末备考系列之省级名校数学压轴大题攻略</caption>
                ...
                <table class="score-table">
                    <caption>一轮复习最后发力之名校名师：英语如何稳拿120分</caption>
