                        ...
                        <tbody id="data_body">
                            <c:forEach var="task" items="${paging.result }">
	                            <tr>
	                                ...
	                                <td>
	                                    <a href="<%=basePath %>/cmsTask/showModiTaskPageForXXT.do?taskId=${task.id}">${task.taskName_}</a>
	                                </td>
	                                <td>
	                                	<c:choose>
...
$.paging('cms_task_list_for_xxt',"cmsTask/getPagingData.do",{},function(data){
	...
	for(var i = 0 ;i< result.length;i++){
		...
		task.subjectType+'"></i></td><td><a href="<%=basePath %>/cmsTask/showModiTaskPageForXXT.do?taskId='+
		task.id+'">'+
		task.taskName_+'</a></td><td><div class="td_style">'+
		task.activeDate+'</div></td><td><div class="td_style"><a href="javascript:deleteTaskForXXT('+
