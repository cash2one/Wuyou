...
<div class="cms-container">
                        ...
                        <div class="L clearfix">
                            ...
                            <div class="label-con">
                            	<form id="subimg_form" name="subimg_form" 
                            		action="${basePath }/fileupload/istudy/subimgUpload.do" method="post"
        	...
        	src="<%=basePath%>xxtM/mPage.do.do?uri=${minisite.miniUrl}"></iframe>
                    ...
                    <div >
                    <a href="javascript:pushTask(this);" class="btn-submit-app">推送至爱学网APP</a>
...
<script type="text/javascript">
    ...
    $().ready(function(){
		...
		$("#hiddenFrame").load(function(){
			...
			if(subimgName){
				var subimgUrl = "${bashPath }/${istudyImgRelativePath }" + subimgName;
				cleanImage();
	...
	function pushTask(obj){
		...
		$.ajax({
   		 type: "POST",
   		 url: "cmsTask/saveTaskInfoForIstudy.do",
   		 data: eval(resouce),
   		 dataType: "json",
